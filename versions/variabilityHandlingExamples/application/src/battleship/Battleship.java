...
public class Battleship {
	...
	@Action(actionType = ActionType.ACTION, message = "d1.checkFinalState", diagramIdentifiers = {"d1.id"}, parentMessage = "d1.createResOr")
	...
	//needs to be public
	@Action(actionType = ActionType.ACTION, message = "d1.makeGuess", diagramIdentifiers = {"d1.id"}, parentMessage = "d1.createResOr")
	...
	//@Action(actionType = ActionType.START, message = "d1.setup", diagramIdentifiers = {"d1.id"}, parentMessage = "d1.createResOr")
	//@Action(actionType = ActionType.END, message = "d1.setup", diagramIdentifiers = {"d1.id"}, parentMessage = "d1.createResOr")
